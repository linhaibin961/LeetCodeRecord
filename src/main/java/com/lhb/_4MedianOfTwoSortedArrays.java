...
public class _4MedianOfTwoSortedArrays {
    ...
    public static double findMedianSortedArraysM1(int[] nums1, int[] nums2) {
        // 解法一
    ...
    public static void main(String[] args) {
        ...
        double medianSortedArrays = _4MedianOfTwoSortedArrays.findMedianSortedArrays(ints1, ints2);
        System.out.println(medianSortedArrays);
        medianSortedArrays = _4MedianOfTwoSortedArrays.findMedianSortedArraysM1(ints1, ints2);
        System.out.println(medianSortedArrays);
    }
}
